 ...
 * description:
 */
class ProjectItemViewModel : ItemViewModel<ProjectViewModel> {
    ...
    constructor(viewModel: ProjectViewModel, entity: NewestModel.DatasBean) : super(viewModel) {
        this.entity = entity
        //ImageView的占位图片，可以解决RecyclerView中图片错误问题
    }

    constructor(viewModel: ProjectViewModel) : super(viewModel)
