 ...
 * description:
 */
class ArticleItemViewModel : ItemViewModel<ArticleViewModel> {
    ...
    constructor(viewModel: ArticleViewModel, entity: NewestModel.DatasBean) : super(viewModel) {
        this.entity = entity
        //ImageView的占位图片，可以解决RecyclerView中图片错误问题
    }

    constructor(viewModel: ArticleViewModel) : super(viewModel)
